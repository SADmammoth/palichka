...
function palichka_customize_register($wp_customize)
{
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'dark_background_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'background_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'light_background_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'buttons_color_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'buttons_hover_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'shadow_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'shadow_opacity_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'primary_text_color_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'secondary_text_color_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Color_Control($wp_customize, 'common_text_color_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'hyphenate_checkbox', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'copy_name_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'copy_year_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'main_desc_text_input', array(
      'label' => __('Имя копирайта для отображения в футере', 'palichka'),
      'section' => 'site_desc',
  ...
  $wp_customize->add_control(
    new WP_Customize_Image_Control($wp_customize, 'pick_main_picture_dialog', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'enable_panel_checkbox', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'sec_desc_text_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'phone_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'email_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Image_Control($wp_customize, 'pick_map_image_dialog', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'map_code_link_input', array(
  ...
  $wp_customize->add_setting('link_on_map', array(
    'default' =>
      'https://yandex.by/maps/155/gomel/?ll=31.006746%2C52.428851&mode=usermaps&source=constructor&um=constructor%3A48aa09255f7b87136b085b14a724126378ab3965881b489652c6c51f68f6d150&z=19'
  ));

  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'link_on_map_input', array(
  ...
  $wp_customize->add_control(
    new WP_Customize_Control($wp_customize, 'adress_input', array(
      'label' => __('Ссылка на карту', 'palichka'),
      'section' => 'contacts',
      'settings' => 'adress',
      'type' => 'text'
