        ...
        <section class='rightside-section'>
          <ul style='list-style-type: none;'>
            <li style='margin-bottom: 5px;'>
              <a class='h3' href='tel:<?php echo get_theme_mod('phone')?>'><i class="fas fa-mobile-alt pictogram" style='margin-right: 5px;'></i><?php echo get_theme_mod('phone')?></a>
            </li>
            <li style='margin-bottom: 5px; margin-left: -5px;'>
              <a class='h3' href='mailto:<?php echo get_theme_mod('email')?>'><i class="fas fa-at pictogram" style='margin-right: 5px;'></i><?php echo get_theme_mod('email')?></a>
            </li>
            <li  style='margin-bottom: 5px;'>
              <a class='h3' href='<?php echo get_theme_mod('link_on_map')?>'>
                <i class="fas fa-map-marker-alt pictogram" style='margin-right: 10px;'></i><?php echo get_theme_mod('adress')?></a>
              <div class='mapbox' style='background-image: url("<?php echo get_theme_mod('map_image');?>")'>
                <script type="text/javascript" charset="utf-8" async src="<?php echo get_theme_mod('map_code_link')?>"></script>
              </div>
            </li>
          </ul>
        </section>
