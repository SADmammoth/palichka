	...
	<div id="primary" class="content-area">
     ...
     <section id ='main-section'>
      ...
      <fieldset class='form-head' style='position: relative;'>
        ...
        <input class='form-input<?php echo isset($_GET["signin"])?" hidden":""?>' name='email' type='email' placeholder='Email'  onchange='check_validity(this)' required/>
        ...
        <input class='form-input<?php echo isset($_GET["signin"])?" hidden":""?>' id='repeat_password' type='password' placeholder='Повторите пароль' required/>
