...
<section id='master-section'>
 ...
 ?>
    ...
    <label for='photo_input'  style='margin-top: -100px; position: relative' ><i class='fas fa-edit' style='font-size: 1.5rem; left: 8px; top: 8px;position: absolute; text-shadow: 0 0 2px white'></i><img  class='photo' id='photo' width='200' height='200' src='<?php echo get_current_user_avatar()?get_current_user_avatar():get_site_url().'/wp-content/uploads/2019/08/tablero-de-paleta-de-pintura-con-contorno-de-pincel.png'?>' alt='<?php echo the_title()?>' title='<?php echo the_title() ?>'/></label>
    </label>
        ...
        <label
              for="email"
                ...
                <input
                  ...
                  onchange='check_email(this, this.form.age_validated || this.form.age_validated===undefined, "<?php echo get_template_directory_uri()."/inc/users.php" ?>"); if(this.value === "<?php echo $user->user_email?>"){this.form.email_validated = true; hide_user_message(true);}'
                />
        ...
        <label
              for="word_about"
                ...
                <input
                  ...
                  class="option-box"
                  type="text"
                  <?php $info = get_user_meta(get_current_user_id(), 'word_about', true); echo $info!==''?
                  'value='.'"'.$info.'"':
                  ''?>
        ...
        <label
              for="age"
                ...
                <input
                  ...
                  class="option-box"
                  type="text"
                  <?php $age = get_user_meta(get_current_user_id(), 'age', true); echo $age!==''?
                  'value='.'"'.$age.'"':
                  ''?>
