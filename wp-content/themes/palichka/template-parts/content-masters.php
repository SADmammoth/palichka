...
get_header(); ?>
 ...
 <?php if (wp_get_current_user()->user_login === basename(get_permalink())): ?>
 ...
 <?php endif; ?>
    <div class='container horizontal-flex-block' style='margin-bottom: 20px; position: relative; justify-content: flex-start;'>
      <img class='photo' width='200' height='200'  src='<?php
        ...
        <div class='master-description'>
          ...
          <p>
            <form method="POST" action="<?php echo get_template_directory_uri() .
              "/inc/like.php"; ?>">
          <input id='best_master' class='like' name='liked' type="checkbox" onchange="like(this, <?php echo get_the_ID() .
            ', ' .
