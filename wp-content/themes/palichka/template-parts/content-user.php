<section id='master-section'>
 ...
 <form class='floating-btn' action='' method='GET'>
    ...
    <div class='container horizontal-flex-block' style='margin-bottom: 20px; position: relative; justify-content: flex-start;'>
      <img class='photo' width='200' height='200'  src='<?php echo get_current_user_avatar()
        ? get_current_user_avatar()
        : get_site_url() .
          '/wp-content/uploads/2019/08/tablero-de-paleta-de-pintura-con-contorno-de-pincel.png'; ?>' alt='<?php echo the_title(); ?>' title='<?php echo the_title(); ?>' />
        ...
        <i class='fas fa-info-circle'></i>
          ...
          echo $info !== '' ? $info : 'Информация не указана';
          ?>
        </p>
        <p class='main-text additional-text'>
        <i class='fas fa-calendar-check'></i>
          ...
          echo $age !== '' ? $age : 'Возраст не указан';
          ?>
        </p>
        </div>
      </div>
