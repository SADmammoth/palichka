...
<div id="signup-content" class="widecolumn">
	...
	<?php if (!$key) { ?>
      ...
      'wp-activate.php'
		...
		<?php } else {if (
         is_wp_error($result) &&
         in_array($result->get_error_code(), $valid_error_codes)
     ) {
   ...
   echo '</p>';
         ...
         ?>
			...
			<p><span class="h3"><?php _e(
       'Username:'
   ); ?></span> <?php echo $user->user_login; ?></p>
			<p><span class="h3"><?php _e('Password:'); ?></span> <?php echo $result[
    'password'
]; ?></p>
			</div>
       ...
       ?>
				<p class="view">
				 /* translators: 1: site URL, 2: login URL */<?php
