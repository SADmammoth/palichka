...
if (
    ...
    isset($_GET['new']) &&
    in_array($_GET['new'], get_site_option('illegal_names'))
) {
...
function show_blog_form($blogname = '', $blog_title = '', $errors = '')
{
    ...
    if (!is_subdomain_install()) {
        ...
        echo '<input name="blogname" type="text" id="blogname" value="' .
            esc_attr($blogname) .
            '" maxlength="60" /><span class="suffix_address">.' .
...
function show_user_form($user_name = '', $user_email = '', $errors = '')
{
 ...
 ?>
	<input name="user_email" type="email" id="user_email" value="<?php echo esc_attr(
     $user_email
 ); ?>" maxlength="200" /><br /><?php _e('We send your registration email to this address. (Double-check your email address before continuing.)'); ?>
	<?php
...
function signup_user($user_name = '', $user_email = '', $errors = '')
{
	...
	<h2>
	 /* translators: %s: name of the network */<?php
	...
	<form id="setupform" method="post" action="wp-signup.php" novalidate="novalidate">
		<input type="hidden" name="stage" value="validate-user-signup" />
		 /** This action is documented in wp-signup.php */<?php
...
function validate_user_signup()
{
    ...
    wpmu_signup_user(
        $user_name,
        $user_email,
        apply_filters('add_signup_meta', array())
    );
...
function confirm_user_signup($user_name, $user_email)
{
	...
	<p>
	 /* translators: %s: email address */<?php
...
function confirm_blog_signup(
    ...
    ?>
	<h2>
	 /* translators: %s: site address */<?php
    /* translators: %s: site address */
    ?>printf(
